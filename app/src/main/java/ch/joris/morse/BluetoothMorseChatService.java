...
public class BluetoothMorseChatService {
   //  TODO: read, learn and organize this class

    // Debugging
    private static final String TAG = "MorseChatService";
     ...
     */
    public BluetoothMorseChatService(Context context, Handler handler) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            synchronized (BluetoothMorseChatService.this) {
                connectThread = null;
            }
    ...
    private void connectionLost() {
        ...
        BluetoothMorseChatService.this.start();
    }
